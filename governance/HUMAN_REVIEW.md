...
| Narrative spot-check | 20 challenge cases (4 per label) | `spotcheck_v1` | **Scripted** second-pass notes (SCOPE/substance/tags); labels retained |
...
Say out loud: *structural auditor + scripted spot-check*, never “humans labeled the challenge set.”
