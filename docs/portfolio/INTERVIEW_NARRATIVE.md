...
The published numbers are much higher for TF-IDF, but they'ren't a controlled cross-family comparison: the classical experiments use v1.1 and the Gemma experiments use v1.0. I report the scores descriptively and make the version boundary explicit.
