...
- **Single small model:** Results for Gemma 3 1B IT don't generalize to larger models or other families without further study.
- **Frozen prompt:** Canonical zero-shot prompt doesn't tutor the packet grammar; discovery failures are valid outcomes.
