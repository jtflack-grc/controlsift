...
- Within Gemma v1.0, few-shot is the strongest run; QLoRA doesn't beat it.
...
> I can evaluate whether domain adaptation improved a model, preserve a negative result when it didn't, identify failure modes, show the evidence behind the conclusion, and explain where the model shouldn't be trusted.
